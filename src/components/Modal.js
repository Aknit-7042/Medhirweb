      ...
      <div className={`flex min-h-full items-center justify-center ${size === 'full' ? 'p-0' : 'p-4'}`}>
        ...
        >
          ...
          {size === 'full' && (
            <button
              onClick={onClose}
              className="fixed top-4 right-4 z-[10000] p-3 bg-white rounded-full shadow-lg text-gray-600 hover:text-gray-800 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
              title="Close"
            >
